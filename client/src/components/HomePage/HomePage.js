          ...
          <div className="row">
            <div className="col-md-6 pitch-column">
              ...
              <h4 className="section-text">
                What are we doing this Friday, that questions comes up more than
                any other question. The back and fourth of ideas. Friday Hero
                allows you to be just that the Hero. You'll have your finger on
