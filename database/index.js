...
//dummy data
let myUser = new User({userID: 1, fName: 'Kuyik', lName: 'Akpan', age: 32, zipcode: 94587, email: 'kjakpan@hackreactor.com', telephone: '5105555555', gender: 'M', status: 'Ready to mingle' });
myUser.save();

//return user by userId
let userById = (id) => {
  return User.findOne({userID: id}, (err, obj) => {console.log(obj)} )
}
